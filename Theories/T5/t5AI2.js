...
export function t5AI2(data) {
  ...
  function buy(vc1, vc2, vc3) {
    ...
    while (
      c1_c <= rho &&
      ((c2Counter > 1 ? iq : q) + Math.log10(1.333) < vc2 + vc3 ||
        !c2worth ||
        c1_c + c1weight <= Math.min(q2_c, c2_c, mc3 > 0 ? c3_c : 1000))
    ) {
    ...
    while (
      q1_c <= rho &&
      (q1_c + q1weight <= Math.min(q2_c, c2_c, mc3 > 0 ? c3_c : 1000) ||
        10 ** (iq - q) > 1.9)
    ) {
