...
export function t3Play2(data) {
  ...
  function simulate() {
    ...
    if (curMult < 1) buyBR();
    else if (curMult >= 1 && curMult < 2) buyAR();
    else if (curMult >= 2) buyE();
  }
  while (true) {
    simulate();
    if (
  ...
  function buyAR() {
    while (c33_c <= rho3 && false) {
      rho3 = subtract(rho3, c33_c);
      c33_c += Math.log10(2.98);
      c33++;
    }
    while (c32_c <= rho2 && c32_c + log8 <= c12_c && milestones[0]) {
      rho2 = subtract(rho2, c32_c);
      c32_c += Math.log10(6.81744);
      c32++;
    }
    ...
    while (c22_c <= rho2 && c22_c + log8 <= c32_c) {
      rho2 = subtract(rho2, c22_c);
      c22_c += Math.log10(3.65);
      c22++;
    }
    ...
    while (b3_c <= rho3 && b3_c + log8 <= c23_c && milestones[0]) {
      ...
      b3 = add(b3, log2 * Math.floor(b3lvl / 10));
      b3lvl++;
      b3weight = Math.log10(5 + (b3lvl % 10));
    }
    while (b2_c <= rho2 && b2_c + log8 <= c32_c) {
      rho2 = subtract(rho2, b2_c);
      b2_c += Math.log10(1.308);
      b2 = add(b2, log2 * Math.floor(b2lvl / 10));
      b2lvl++;
      b2weight = Math.log10(2.5 + (b3lvl % 10));
    }
  }
  function buyE() {
    while (c33_c <= rho3 && false) {
    ...
    while (b3_c <= rho3 && milestones[0]) {
      rho3 = subtract(rho3, b3_c);
      b3_c += Math.log10(1.675);
      b3 = add(b3, log2 * Math.floor(b3lvl / 10));
      b3lvl++;
      b3weight = Math.log10(10 + (b3lvl % 10));
    }
    while (b2_c <= rho2) {
      rho2 = subtract(rho2, b2_c);
      b2_c += Math.log10(1.308);
      b2 = add(b2, log2 * Math.floor(b2lvl / 10));
      b2lvl++;
      b2weight = Math.log10(10 + (b2lvl % 10));
    }
  }
}
