...
export function t3(data) {
  ...
  function buy() {
    ...
    while (c21_c <= rho) {
      rho = subtract(rho, c21_c);
      c21_c += Math.log10(18.8343);
      c21++;
    }
    while (c13_c <= rho3 && milestones[0]) {
      rho3 = subtract(rho3, c13_c);
      c13_c += Math.log10(1.965);
      c13++;
    }
    while (c12_c <= rho2) {
    ...
    while (c11_c <= rho) {
      rho = subtract(rho, c11_c);
      c11_c += Math.log10(6.3496);
      c11++;
    }
