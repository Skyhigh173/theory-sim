...
export function t3Play(data) {
  ...
  function buyBR() {
    ...
    while (c22_c <= rho2 && c22_c + log2 <= Math.min(c12_c, c32_c)) {
    ...
    while (
      b2_c <= rho2 &&
      b2_c + Math.log10(4.5) <= c22_c &&
      b2_c + Math.log10(2.25) <= c12_c
    ) {
    ...
    while (b1_c <= rho && b1_c + log8 <= c31_c) {
  ...
  function buyAR() {
    while (c33_c <= rho3 && c33_c + Math.log10(2.5) <= c23_c && milestones[0]) {
      rho3 = subtract(rho3, c33_c);
      c33_c += Math.log10(2.98);
      c33++;
    }
    ...
    while (
      b2_c <= rho2 &&
      b2_c + Math.log10(2.5) <= Math.min(c12_c, c32_c) &&
      b2_c + log2 <= c22_c
    ) {
      rho2 = subtract(rho2, b2_c);
      b2_c += Math.log10(1.308);
